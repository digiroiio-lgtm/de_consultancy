  ...
  return (
    <div>
      ...
      >
        ...
        <h2 className="h2" style={{ color: "var(--fg)", marginBottom: 16 }}>Ekibimizle Tanışın</h2>
        <p style={{ fontSize: 17, color: "var(--muted)", marginBottom: 32, maxWidth: 480 }}>
          Her proje bir kurucu ortak tarafından yürütülür — alt kademelere devredilmez. İşin arkasındaki ekibimizi tanıyın.
        </p>
        <Link href="/tr/hakkimizda/ekibimiz" className="btn-outline">
          Ekibimizi Görüntüle →
        </Link>
      </section>
    </div>
