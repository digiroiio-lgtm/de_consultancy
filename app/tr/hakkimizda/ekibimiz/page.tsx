...
export const metadata: Metadata = {
  title: "Ekibimiz | Advisera Global",
  description:
    "Advisera Global ekibini tanıyın — üretim, ihracat büyümesi ve operasyonel mükemmellik konularında derin deneyime sahip uzman operatörler.",
...
export default function TrEkibimizPage() {
  return (
    <div>
      <SchemaScript
        data={[
          breadcrumbSchema([
            ...
            { name: "Ekibimiz", path: "/tr/hakkimizda/ekibimiz" },
          ]),
        ]}
      />
