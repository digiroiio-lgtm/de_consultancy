...
export const metadata: Metadata = {
  title: "Karlılığı Artırın. Küresel Büyüyün.",
  description:
    "Üreticiler için kurumsal yönetim ve ihracat danışmanlığı. Marjları iyileştirmek ve uluslararası büyümeyi ölçeklendirmek için strateji görüşmesi yapın.",
    ...
    <>
      ...
      >
        ...
        <h1 className="h1" style={{ color: "var(--fg)", maxWidth: 800, marginBottom: 32 }}>
          Karlılığı Artırın.<br />Küresel Büyüyün.
        </h1>
        <p className="body-lg" style={{ color: "var(--muted)", maxWidth: 560, marginBottom: 48 }}>
          Ölçülebilir sonuç isteyen üreticiler için kurumsal yönetim ve ihracat danışmanlığı. Marjları iyileştirmek ve uluslararası büyümeyi ölçeklendirmek için strateji görüşmesi yapın.
        </p>
