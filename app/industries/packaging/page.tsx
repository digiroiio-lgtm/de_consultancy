...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/industries/packaging" },
};
  ...
  return (
    <div >
      ...
      <section style={{ paddingBlock: "clamp(120px,14vw,200px) clamp(80px,10vw,120px)", paddingInline: "clamp(24px,5vw,80px)", borderBottom: "1px solid var(--border)" }} className="max-w-site">
        <h1 className="h1" style={{ color: "var(--fg)", maxWidth: 720, marginBottom: 16 }}>Packaging Industry Consulting</h1>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          <li style={{ fontSize: 15, color: "var(--muted)", paddingLeft: 0, display: "flex", gap: 10 }}><span style={{ color: "#a100ff" }}>→</span>Raw material cost swings and contract pricing lag</li>
          <li style={{ fontSize: 15, color: "var(--muted)", paddingLeft: 0, display: "flex", gap: 10 }}><span style={{ color: "#a100ff" }}>→</span>Yield loss and waste on high-volume lines</li>
          <li style={{ fontSize: 15, color: "var(--muted)", paddingLeft: 0, display: "flex", gap: 10 }}><span style={{ color: "#a100ff" }}>→</span>Distributor pressure on net price</li>
        </ul>
        <h3 style={{ fontSize: 18, fontWeight: 700, color: "var(--fg)", marginTop: 28, marginBottom: 10 }}>Solutions</h3>
        <p style={{ fontSize: 15, color: "var(--muted)", lineHeight: 1.65 }}>Procurement control towers, waste reduction systems, and margin-protecting price architecture.</p>
        <p style={{ fontSize: 15, color: "var(--fg-weaker)", marginTop: 16 }}>Case example: 18% cost reduction in 90 days for a corrugated producer.</p>
      </section>
