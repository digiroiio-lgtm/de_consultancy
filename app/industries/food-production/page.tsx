  ...
  return (
    <div >
      ...
      <section style={{ paddingBlock: "clamp(120px,14vw,200px) clamp(80px,10vw,120px)", paddingInline: "clamp(24px,5vw,80px)", borderBottom: "1px solid rgba(255,255,255,0.08)" }} className="max-w-site">
        <h1 className="h1" style={{ color: "#fff", maxWidth: 720, marginBottom: 16 }}>Food Production Consulting</h1>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12, marginTop: 10 }}>
          <li style={{ fontSize: 15, color: "rgba(255,255,255,0.6)", paddingLeft: 0, display: "flex", gap: 10 }}><span style={{ color: "#a100ff" }}>→</span>Volatile demand and promotion-driven planning gaps</li>
          <li style={{ fontSize: 15, color: "rgba(255,255,255,0.6)", paddingLeft: 0, display: "flex", gap: 10 }}><span style={{ color: "#a100ff" }}>→</span>Export compliance complexity and labeling risk</li>
          <li style={{ fontSize: 15, color: "rgba(255,255,255,0.6)", paddingLeft: 0, display: "flex", gap: 10 }}><span style={{ color: "#a100ff" }}>→</span>Low visibility across distributor performance</li>
        </ul>
        <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginTop: 28, marginBottom: 10 }}>Solutions</h3>
        <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", lineHeight: 1.65 }}>Integrated planning cadence, distributor scorecards, and export market pricing strategy.</p>
        <p style={{ fontSize: 15, color: "rgba(255,255,255,0.45)", marginTop: 16 }}>Case example: entered US market with 3 distributors.</p>
      </section>
